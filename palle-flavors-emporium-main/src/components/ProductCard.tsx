      ...
      <Link to={`/product/${product.slug}`} className="block">
        <div className="relative overflow-hidden rounded-3xl bg-paper-warm aspect-square shadow-soft transition-all duration-500 group-hover:shadow-clay">
          ...
          <Button
            ...
            className="absolute bottom-4 right-4 rounded-full h-12 w-12 bg-primary hover:bg-primary-glow text-primary-foreground shadow-elegant translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500"
