    ...
    <section className="bg-[#f7f1e7] py-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="mt-2 text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#b14d1c]">
            Our Collections
          </h2>
        ...
        {/* Desktop Grid */}
        <div className="hidden lg:block relative overflow-hidden rounded-[32px] shadow-2xl bg-gradient-to-r from-[#f6e7d5] via-[#fff6ea] to-[#f3e3cf] py-24 px-10">
          ...
          <div className="relative grid grid-cols-6 gap-5">
            ...
            {categories.map((cat) => (
              ...
              >
                ...
                <Link
                  to={cat.link}
                  className={`group flex items-center justify-center gap-2 rounded-full border border-[#ead8c3] bg-white py-3 px-5 text-base font-semibold shadow-sm transition-all duration-300 hover:shadow-lg hover:scale-105 ${cat.color}`}
                >
                  Explore Collection
        ...
        {/* MOBILE & TABLET */}
        <div className="lg:hidden relative overflow-hidden rounded-[28px] shadow-2xl bg-gradient-to-r from-[#f6e7d5] via-[#fff6ea] to-[#f3e3cf] py-10 px-4">
          ...
          <div className="relative flex gap-4 overflow-x-auto snap-x snap-mandatory scrollbar-hide pb-4">
            ...
            {categories.map((cat) => (
              <div
                key={cat.id}
                className="min-w-[260px] sm:min-w-[320px] bg-[#fffaf3] rounded-[24px] border border-[#ead8c3] shadow-xl p-5 flex flex-col justify-between min-h-[240px] snap-center flex-shrink-0"
              >
                ...
                <div className="flex-1 flex items-center justify-center text-center py-6">
                  ...
                  <h3
                    className={`text-3xl sm:text-4xl leading-tight font-extrabold ${cat.color}`}
                    style={{
                      fontFamily: "'Times New Roman', serif",
                    }}
                  >
                ...
                <Link
                  to={cat.link}
                  className={`group flex items-center justify-center gap-2 rounded-full border border-[#ead8c3] bg-white py-3 px-5 text-sm sm:text-base font-semibold shadow-sm transition-all duration-300 ${cat.color}`}
                >
                  Explore Collection
