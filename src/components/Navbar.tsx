    ...
    >
      <div className="container flex items-center justify-between h-20">
        <Link to="/" className="flex items-center gap-3 group">
          <div className="relative w-11 h-11 rounded-full bg-gradient-spice grid place-items-center shadow-elegant transition-transform group-hover:rotate-12">
            <span className="font-display text-primary-foreground text-xl font-bold">R</span>
          </div>
          <div className="leading-tight">
            <div className="font-display text-xl font-semibold text-ink tracking-tight">Ram Pickel Mart</div>
            <div className="text-[10px] uppercase tracking-[0.25em] text-muted-foreground -mt-0.5">Flavors of Andhra</div>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-1">
          ...
          <Button variant="ghost" size="icon" className="lg:hidden" onClick={() => setMobile((m) => !m)} aria-label="Menu">
