...
INSERT INTO orders (user_id, total_amount, currency, status, payment_provider, items, shipping_address)
VALUES (
  '00000000-0000-0000-0000-000000000000', -- replace with a real auth user_id
  500,
  'INR',
  'pending',
  'razorpay',
